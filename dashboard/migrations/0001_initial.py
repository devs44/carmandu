# Generated by Django 3.2.3 on 2021-06-30 08:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('Red', 'Red'), ('White', 'Red'), ('Grey', 'Grey')], max_length=200)),
                ...
                ('features', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.features')),
                ('model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.model')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.type')),
            ],
            options={
                'verbose_name': 'Car',
